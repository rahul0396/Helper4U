...
function Why() {
  return (
    <div className=" text-center ">
      <h3 className=" text-3xl font-bold py-10  bg-slate-100">Why Choose Us </h3>
      ...
      <div className=" flex bg-slate-100">
        {Details.map((item, index) => {
          return (
            <div
              key={index}
              className="  w-full flex  border  rounded-lg text-white bg-sky-500 hover:bg-blue-500 cursor-pointer: py-5 mx-8 "
            >
              <div className=" ">
